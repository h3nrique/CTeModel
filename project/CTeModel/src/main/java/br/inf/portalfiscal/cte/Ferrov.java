 ...
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="ratVag" minOccurs="0">
 *                     &lt;complexType>
 *                       &lt;complexContent>
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;choice>
 *                             &lt;element name="ratNF" maxOccurs="unbounded">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
 ...
 *                                         &lt;/simpleType>
 *                                       &lt;/element>
 *                                       &lt;element name="pesoRat" type="{http://www.portalfiscal.inf.br/cte}TDec_0302"/>
 *                                     &lt;/sequence>
 *                                   &lt;/restriction>
 *                                 &lt;/complexContent>
 *                               &lt;/complexType>
 *                             &lt;/element>
 *                             &lt;element name="ratNFe" maxOccurs="unbounded">
 *                               &lt;complexType>
 *                                 &lt;complexContent>
 *                                   &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                                     &lt;sequence>
...
public class Ferrov {
    ...
    public static class DetVag {
        ...
        protected List<Ferrov.DetVag.LacDetVag> lacDetVag;
        protected List<Ferrov.DetVag.ContVag> contVag;
        protected Ferrov.DetVag.RatVag ratVag;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ferrov.DetVag.LacDetVag }
         * 
         * 
         */
        public List<Ferrov.DetVag.LacDetVag> getLacDetVag() {
            if (lacDetVag == null) {
                lacDetVag = new ArrayList<Ferrov.DetVag.LacDetVag>();
            }
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link Ferrov.DetVag.ContVag }
         * 
         * 
         */
        public List<Ferrov.DetVag.ContVag> getContVag() {
            if (contVag == null) {
                contVag = new ArrayList<Ferrov.DetVag.ContVag>();
            }
            return this.contVag;
        }

        /**
         * Gets the value of the ratVag property.
         * 
         * @return
         *     possible object is
         *     {@link Ferrov.DetVag.RatVag }
         *     
         */
        public Ferrov.DetVag.RatVag getRatVag() {
            return ratVag;
        }

        /**
         * Sets the value of the ratVag property.
         * 
         * @param value
         *     allowed object is
         *     {@link Ferrov.DetVag.RatVag }
         *     
         */
        public void setRatVag(Ferrov.DetVag.RatVag value) {
            this.ratVag = value;
        }
        ...
        public static class RatVag {

            protected List<Ferrov.DetVag.RatVag.RatNF> ratNF;
            protected List<Ferrov.DetVag.RatVag.RatNFe> ratNFe;

            /**
             * Gets the value of the ratNF property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the ratNF property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getRatNF().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Ferrov.DetVag.RatVag.RatNF }
             * 
             * 
             */
            public List<Ferrov.DetVag.RatVag.RatNF> getRatNF() {
                if (ratNF == null) {
                    ratNF = new ArrayList<Ferrov.DetVag.RatVag.RatNF>();
                }
                return this.ratNF;
            }

            /**
             * Gets the value of the ratNFe property.
             * 
             * <p>
             * This accessor method returns a reference to the live list,
             * not a snapshot. Therefore any modification you make to the
             * returned list will be present inside the JAXB object.
             * This is why there is not a <CODE>set</CODE> method for the ratNFe property.
             * 
             * <p>
             * For example, to add a new item, do as follows:
             * <pre>
             *    getRatNFe().add(newItem);
             * </pre>
             * 
             * 
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link Ferrov.DetVag.RatVag.RatNFe }
             * 
             * 
             */
            public List<Ferrov.DetVag.RatVag.RatNFe> getRatNFe() {
                if (ratNFe == null) {
                    ratNFe = new ArrayList<Ferrov.DetVag.RatVag.RatNFe>();
                }
                return this.ratNFe;
            }
            ...
            public static class RatNF {
                ...
                /**
                 * Gets the value of the pesoRat property.
                 * 
                 * @return
                 *     possible object is
                 *     {@link String }
                ...
                /**
                 * Sets the value of the pesoRat property.
                 * 
                 * @param value
                 *     allowed object is
                 *     {@link String }
                 *     
                 */
                public void setPesoRat(String value) {
                    this.pesoRat = value;
                }
